...
const DeleteModal: React.FC<DeleteModalProps> = ({ items, onClose, onConfirm, itemClass }) => {
  return (
    <div className='absolute z-[90] top-0 left-0 right-0 bottom-0 bg-gray-500/50'>
        ...
        <div className="relative flex flex-col bg-white border shadow-sm rounded-xl overflow-hidden dark:bg-gray-800 dark:border-gray-700">
          ...
          <div className="p-4 sm:p-10 overflow-y-auto">
            <div className="flex gap-x-4 md:gap-x-7">
              ...
              {/* Make Prompt Universal */}
              <div className="grow">
                <h3 className="mb-2 text-xl font-bold text-gray-800 dark:text-gray-200">
                  Delete Selected {itemClass}
                </h3>
                <p className="text-gray-500">
                  Permanently remove <span className='font-semibold'>{items.length} {itemClass}</span> and their data from the portal.
